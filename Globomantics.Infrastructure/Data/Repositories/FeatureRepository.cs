...
public class FeatureRepository : TodoRepository<Feature>
{
    ...
    public override async Task AddAsync(Feature feature)
    {
        ...
        var user = await Context.Users.FirstOrDefaultAsync(u => u.Id == feature.Id);
    ...
    private async Task UpdateAsync(Feature feature,Models.Feature featureToUpdate, Models.User user)
    {
    ...
    {
        var featureToAdd = DomainToDataMapping.MapTodoFromDomain<Feature, Models.Feature>(feature);
